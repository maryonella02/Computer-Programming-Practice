//Conversor de numere romane (pana la 5000) in numere arabe
//Convertor of roman numbers (up to 5000) into arabic numbers
...
int main(int argc, const char **argv)
{
    char* roman;
    int n;
    printf("Dati lungimea numarului roman");
    scanf("%d", &n);
    roman = malloc(sizeof(char) * n);
    printf("Dati numarul roman");
    scanf("%s", roman);

    printf("Rezultatul este : %d", intFromRoman(roman));
